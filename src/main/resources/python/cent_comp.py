...
mydir_putty = os.path.join(
        "/home/amedishetti/Artifact_Comparator/putty_dump_"+timecurrent)
os.makedirs(mydir_putty)
mydir_perforce = os.path.join(
        "/home/amedishetti/Artifact_Comparator/Perforce_dump_"+timecurrent)
...
file_final = "/home/amedishetti/Artifact_Comparator/sp/"+name+".txt"
fo = open(file_final,'w')
...
try:
    ...
    for row in res:
        ...
        file_prod = "/home/amedishetti/Artifact_Comparator/sp/Archive/"+r+"_prod.txt"
        file_env = "/home/amedishetti/Artifact_Comparator/sp/Archive/"+r+"_"+z+".txt"
        file_output= "/home/amedishetti/Artifact_Comparator/sp/Archive/outputfile.txt"
        file_us = "/home/amedishetti/Artifact_Comparator/sp/"+r+"_"+z+"_compare.txt"
        ...
        for row in results:
            ...
            if(s[0:2]=="wf"):
                ...
                stdin, stdout, stderr = ssh.exec_command('pmrep objectexport -o workflow -f Sales_Forecasting -n wf_Pipeline_EDW_WAVE_Scratch_Pad_Snapshot_Load -m -s -b -r -u /home/amedishetti/Artifact_Comparator/workflows/WORKFLOW.xml')
                stdin, stdout, stderr = ssh.exec_command('pmrep objectexport -o workflow -f Sales_Forecasting -n wf_Pipeline_EDW_WAVE_Scratch_Pad_Snapshot_Load_incremental -m -s -b -r -u /home/amedishetti/Artifact_Comparator/workflows/WORKFLOW_dev.xml')
                print(stdout)
        ...
        with open("/home/amedishetti/Artifact_Comparator/sp/Archive/outputfile.txt") as f:
            for line in f:
                
                lines=line.splitlines()
                
        with open('/home/amedishetti/Artifact_Comparator/sp/Archive/outputfile.txt', 'r') as f2:
            lines = f2.readlines()
        # remove spaces
        lines = [line.replace(' ', '') for line in lines]
        # finally, write lines in the file
        with open('/home/amedishetti/Artifact_Comparator/sp/Archive/outputfile.txt', 'w') as f3:
            f3.writelines(lines)
            f3.close()
        with open('/home/amedishetti/Artifact_Comparator/sp/Archive/outputfile.txt') as f:
            ...
            for i in reader:
                ...
                p4.connect()
                info = p4.run("info")
                #p4.run_print("-q", "-o", "'/home/amedishetti/Artifact_Comparator/sp/Perforce_dump/"+i[0],i[1]+"#head")
        ...
        #directory = os.fsencode(''/home/amedishetti/Artifact_Comparator/sp/Archive/python scripts/Perforce_dump')
    ...
    connection.close()
    f.close()
    s = "python3.4 sqlparser.py CSM-1780 \"Deploy inf sql\" uat "+file_final
    os.system(s)
fo.close()
ssh=createSSHClient('inf-dev11-inta1', '22', 'infa', 'welcomedev1108')
scp=SCPClient(ssh.get_transport())
