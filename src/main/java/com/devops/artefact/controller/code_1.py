    ...
    for row in res:
        ...
        for row in results:
            ...
            if(s[0:2]=="wf"):
                ...
                print("The workflows with the changes in Prod and "+z+" are", file=open(file_us,"a"))
        ...
        f1 = open("C:\\Users\\amedishetti\\Desktop\\sp\\"+r+"compfile.txt","w")
        ...
        with open('C:\\Users\\amedishetti\\Desktop\\sp\\outputfile.txt', 'r') as f2:
            lines = f2.readlines()
        # remove spaces
        lines = [line.replace(' ', '') for line in lines]
        # finally, write lines in the file
        with open('C:\\Users\\amedishetti\\Desktop\\sp\\outputfile.txt', 'w') as f3:
            f3.writelines(lines)
            f3.close()
        with open('C:\\Users\\amedishetti\\Desktop\\sp\\outputfile.txt') as f:
        ...
        for file in os.listdir(directory):
            ...
            if filename.endswith(".properties") or filename.endswith(".py"):
                ...
                f1.write("INFO:No more files to be read")
        f1.close() 
        sys.stdout.close()

        f1 = open("C:\\Users\\amedishetti\\Desktop\\sp\\"+r+"compfile.txt","r")
        #f = open('./test.txt','r')
        a = ['set()']
        lst = []
        for line in f1:
